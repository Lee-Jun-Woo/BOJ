# 백준 온라인 저지
솔브드 프로필: [![Solved.ac Profile](http://mazassumnida.wtf/api/v2/generate_badge?boj=ljw1029boj)](https://solved.ac/ljw1029boj)\
블로그 링크: https://velog.io/@necu1029/posts \
백준 온라인 저지(이하 BOJ) 문제들의 정답 코드를 올리는 리포지토리입니다. 제가 주로 Python을 사용해서 Python 코드가 많이 올라올 예정이지만, 다른 언어의 코드도 가끔씩 올라올 예정입니다.
...
<table>
  ...
  <tr>
    ...
    <td><a href="https://velog.io/@necu1029/%EB%B0%B1%EC%A4%80-%EC%98%A8%EB%9D%BC%EC%9D%B8-%EC%A0%80%EC%A7%80BOJ-1717-%EC%A7%91%ED%95%A9%EC%9D%98-%ED%91%9C%ED%98%84-%EB%AC%B8%EC%A0%9C%ED%92%80%EC%9D%B4-python">링크</a></td>
  </tr>
  <tr>
